...
Gives replies based on simple rules
...
├── handlers/        # Extra modules for responses
...
git clone https://github.com/hmtvd/Enigmatica.git
cd Enigmatica/Enigmatica
...
Add new reply logic inside the handlers/ folder

Update chatbot.py to include your new logic
